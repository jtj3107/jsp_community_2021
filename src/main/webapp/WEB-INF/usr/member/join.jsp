...
<section class="section section-member-join flex-grow flex justify-center items-center">
      ...
      <div class="px-4 py-4">
        <form action="../member/doJoin" method="POST" onsubmit="MemberJoin__submit(this); return false;">
          ...
          <div class="form-control">
            ...
            <div>
              <input class="input input-bordered w-full" maxlength="100" name="loginPwConfirm" type="password"
